 ...
 */
abstract class Hilt_AdminHomeFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdminHomeFragment(Inflate<VB> inflate) {
    super(inflate);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdminHomeFragment_GeneratedInjector) this.generatedComponent()).injectAdminHomeFragment(UnsafeCasts.<AdminHomeFragment>unsafeCast(this));
    }
  }
