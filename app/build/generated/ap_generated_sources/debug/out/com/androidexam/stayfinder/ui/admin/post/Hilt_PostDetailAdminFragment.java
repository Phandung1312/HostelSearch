 ...
 */
abstract class Hilt_PostDetailAdminFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_PostDetailAdminFragment(Inflate<VB> inflate) {
    super(inflate);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PostDetailAdminFragment_GeneratedInjector) this.generatedComponent()).injectPostDetailAdminFragment(UnsafeCasts.<PostDetailAdminFragment>unsafeCast(this));
    }
  }
