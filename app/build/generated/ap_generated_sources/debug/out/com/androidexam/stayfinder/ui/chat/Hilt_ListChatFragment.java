 ...
 */
abstract class Hilt_ListChatFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ListChatFragment(Inflate<VB> inflate) {
    super(inflate);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListChatFragment_GeneratedInjector) this.generatedComponent()).injectListChatFragment(UnsafeCasts.<ListChatFragment>unsafeCast(this));
    }
  }
